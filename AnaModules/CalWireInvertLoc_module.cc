////////////////////////////////////////////////////////////////////////
//
// CalWireInvertLoc class - variant of CalWire that inverts RawDigit signals
...
class CalWireInvertLoc : public art::EDProducer
{
public:
    
    // create calibrated signals on wires. this class runs 
    // an fft to remove the electronics shaping.     
    explicit CalWireInvertLoc(fhicl::ParameterSet const& pset); 
    virtual ~CalWireInvertLoc();
...
}; // class CalWireInvertLoc

DEFINE_ART_MODULE(CalWireInvertLoc)
  
//-------------------------------------------------
CalWireInvertLoc::CalWireInvertLoc(fhicl::ParameterSet const& pset) :
...
//-------------------------------------------------
CalWireInvertLoc::~CalWireInvertLoc()
{
}

//////////////////////////////////////////////////////
void CalWireInvertLoc::reconfigure(fhicl::ParameterSet const& p)
{
...
//-------------------------------------------------
void CalWireInvertLoc::beginJob()
{
    fEventCount = 0;
} // beginJob

//////////////////////////////////////////////////////
void CalWireInvertLoc::endJob()
{  
}

//////////////////////////////////////////////////////
void CalWireInvertLoc::produce(art::Event& evt)
{
    ...
    if(wirecol->size() == 0)
        mf::LogWarning("CalWireInvertLoc") << "No wires made for this event.";
...
float CalWireInvertLoc::SubtractBaseline(std::vector<float>& holder, float basePre,
