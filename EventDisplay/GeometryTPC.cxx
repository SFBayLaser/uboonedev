/// \file    GeometryTPC.cxx
/// \brief   Class to aid in the rendering of Geometry objects
/// \author  messier@indiana.edu
/// \version $Id: GeometryTPC.cxx,v 1.2 2010/11/11 18:11:22 p-novaart Exp $
...
namespace evdb3D
{
    ...
    //......................................................................
    void GeometryTPC::DetOutline3D()
    {
        art::ServiceHandle<geo::Geometry> geo;
/*
        double xlo =  -2.  * geo->DetHalfWidth();
        double xhi =   4.  * geo->DetHalfWidth();
        double ylo =  -1.5 * geo->DetHalfHeight();
        double yhi =   1.5 * geo->DetHalfHeight();
        double zlo =  -0.2 * geo->DetLength();
        double zhi =   1.2 * geo->DetLength();
